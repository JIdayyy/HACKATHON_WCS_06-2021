    ...
    <div className="h-screen w-screen text-white bg-backGround bg-cover bg-no-repeat bg-center z-50 flex-col absolute top-0 items-center justify-center min-h-screen py-2">
      ...
      <div className="text-white w-screen mt-20 flex flex-col justify-center items-center">
        <div className="font-Open text-center">
          ...
          <h2 className="mt-12 sm:text-5xl text-3xl font-bold">Find your perfect squad and speed up your projects.</h2>
        </div>
        <div className="text-center font-Montserrat mt-16">
          <h2 className="sm:text-3xl text-2xl font-light">You are aproject Manager or a freelancer</h2>
          <h3 className="mt-5 sm:text-2xl text-lg font-light">Find the team you need already build and ready to work on your dream project. </h3>
        </div>
        <div className="flex flex-col sm:flex-row sm:w-4/12 mt-20 justify-between">
          <Link href="/squad">
